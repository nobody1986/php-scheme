	...
	<div class="layoutBox">
            ...
            <div class="searchBar">
                <ul class="searchContent">
                    ...
                    <li>
                        ...
                        <?php if(is_array($module)): $i = 0; $__LIST__ = $module;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if(($key) == $_REQUEST["module"]): ?>selected<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </SELECT>
                    </li>
                </ul>
                <div class="subBar">
		...
		<div class="panelBar">
			<ul class="toolBar">
				...
				<li><a class="edit" href="__URL__/edit/id/{sid_category}" target="dialog"  width="590" height="420" mask="true" warn="请选择一条记录"><span>编辑</span></a></li>
		...
		<table class="list" width="100%" layoutH="100">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="sid_category" rel="<?php echo ($vo['id']); ?>">
					...
					<td><a class="edit" href="__URL__/edit/id/<?php echo ($vo['id']); ?>" target="dialog"  width="590" height="420" mask="true"><?php echo ($vo['title']); ?></a></td>
					<td><?php echo (getcategoryname($vo['pid'])); ?></td>
					<td><?php echo (getmodulename($vo['module'])); ?></td>
					...
					<td><?php echo (showstatus($vo['status'],$vo['id'])); ?> | <a class="delete" href="__URL__/foreverdelete/id/<?php echo ($vo['id']); ?>/navTabId/__MODULE__" target="ajaxTodo" title="确实要删这条记录吗？"><span>删除</span></a> | <a href="__ROOT__/index.php/<?php echo ($vo['module']); ?>/index/id/<?php echo ($vo['id']); ?>" target="_blank"><span>预览</span></a></td>

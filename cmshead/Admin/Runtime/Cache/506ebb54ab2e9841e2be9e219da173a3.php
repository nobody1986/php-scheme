<?php if (!defined('THINK_PATH')) exit();?><div class="page">
	<div class="layoutBox">
		...
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="__URL__/add" target="dialog" width="590" height="460" mask="true"><span>新增</span></a></li>
				<li><a class="edit" href="__URL__/edit/id/{sid_category}" target="dialog" width="590" height="460" mask="true" warn="请选择一条记录"><span>编辑</span></a></li>
		...
		<table class="list" width="100%" layoutH="100">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="sid_category" rel="<?php echo ($vo['id']); ?>">
					...
					<td><a class="edit" href="__URL__/edit/id/<?php echo ($vo['id']); ?>" target="dialog" width="590" height="460" mask="true"><?php echo ($vo['title']); ?></a></td>
					...
					<td><?php echo (showstatus($vo['status'],$vo['id'])); ?> | <a class="add" href="__URL__/view/id/<?php echo ($vo["id"]); ?>" target="dialog" width="652" height="80" rel="<?php echo ($vo["id"]); ?>" title="<?php echo ($vo["title"]); ?>" mask="true" >播放</a></td>					

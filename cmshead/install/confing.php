	...
	<div class="body">
		...
		<ul class="ck_ul">
			...
			<li style="padding-left:50px;">
				...
				<span class="lf">
					<input class="inpt" id="db_name" name="db_name" value="cmshead"/>
			...
			<li style="padding-left:50px;">
				...
				<span class="lf">
					<input class="inpt" id="db_pre" name="db_pre" value="ch_"/>
		...
		<ul class="ck_ul">
			...
			<li style="padding-left:50px;">
				...
				<span class="lf">
					<input class="inpt" id="SITE_NAME"  name="SITE_NAME" value="CMSHead网站管理系统"/>
			...
			<li style="padding-left:50px;">
				...
				<span class="lf">
					<input class="inpt" id="SITE_KEYWORDS"  name="SITE_KEYWORDS" value="CMSHead,PHP CMS,ThinkPHPCMS,DWZ,jUI"/>
			...
			<li style="padding-left:50px;">
				...
				<span class="lf">
					<input class="inpt" id="SITE_DESCRIPTION"  name="SITE_DESCRIPTION" value="CMSHead是一套基于ThinkPHP和DWZ(jUI)的PHP CMS，类似于帝国CMS，织梦CMS（DEDECMS）等，但它还具有插件分享机制等优点。"/>

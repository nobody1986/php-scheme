...
<div class="wrap">
    ...
    <div class="wrap_left">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="diary_block">
            	<div class="title"><span style="float:right"><?php echo (date('Y-m-d H:i:s',$vo["add_time"])); ?></span><?php echo ($vo["weather"]); ?></div>
                <div class="content" title="<?php echo ($vo["content"]); ?>"><?php echo ($vo["content"]); ?></div>
            </div><?php endforeach; endif; else: echo "" ;endif; ?><!--日记列表-->

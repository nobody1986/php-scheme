...
<div class="wrap">
    ...
    <div class="wrap_left">    
    <script type="text/javascript" src="__PUBLIC__/Plugin/Highslide/highslide-with-gallery.js"></script>
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/Plugin/Highslide/highslide.css" />
    <!--[if lt IE 7]>
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/Plugin/Highslide/highslide-ie6.css" />
    <![endif]-->
    
    <script type="text/javascript">
    hs.graphicsDir = '__PUBLIC__/Plugin/Highslide/graphics/';
    hs.align = 'center';
    ...
    hs.addSlideshow({
        ...
        <div class="rbox5">
            ...
            <div class="rbox5_center">
                <h2>
                	<?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo ($vo["url"]); ?>" style="margin-right:20px"><?php echo ($vo["title"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                </h2>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="pho_block">
                    <table class="img_table"><tr><td>
                        <a href='__PUBLIC__/Upload/photo/<?php echo ($vo["img"]); ?>' onclick="return hs.expand(this)">
                            <img src='__PUBLIC__/Upload/photo/thumb_<?php echo ($vo["img"]); ?>' alt='<?php echo ($vo["title"]); ?>'/></a>
                    </td></tr></table>

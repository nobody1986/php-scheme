    ...
    <div class="wrap_left">
        <div class="rbox5">
            ...
            <div class="rbox5_center">
            	<h2>视频标题：<?php echo ($info["title"]); ?></h2>
            	<?php if(isset($local)): ?><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="660" height="380">
					<param name="movie" value="__PUBLIC__/Plugin/Flvplayer/Flvplayer.swf">
					<param name="quality" value="high">
					<param name="wmode" value="transparent">
					<param name="allowFullScreen" value="true" />
					<param name="FlashVars" value="vcastr_file=__PUBLIC__/Upload/video/<?php echo ($info["url"]); ?>&IsAutoPlay=0" />	
					<embed src="__PUBLIC__/Plugin/Flvplayer/Flvplayer.swf" allowFullScreen="true" FlashVars="vcastr_file=__PUBLIC__/Upload/video/<?php echo ($info["url"]); ?>&IsAutoPlay=0" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="660" height="380" wmode="transparent"></embed>
					</object>
				<?php else: ?>
					<embed src="<?php echo ($info["url"]); ?>" quality="high" width="660" height="380" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" wmode="transparent"></embed><?php endif; ?>
            </div>
            ...
            <div class="rbox5_center">
                ...
                <div class="sub_form">
                        ...
                        <div>
                          ...
                          <label class="required">视频标题（必须）</label>
                        </div>
                        <div>
				...
				function postData(){
					...
					$.post("__URL__/add", {"verify":$("#verify").val(),"title":$("#title").val(),"url":$("#url").val(),"description":$("#description").val(),"tid":$("#tid").val()}, function(msg) {
						$("#postTemp").html(msg);
						$("#verify").val('');
						$("#title").val('');
						$("#url").val('');

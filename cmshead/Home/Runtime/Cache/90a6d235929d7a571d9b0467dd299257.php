            ...
            <div class="rbox5_center">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div>
                    	<table class="video_table">
                    		<tr><td style="border-bottom:#FFF solid 1px; height:97px"><a href="<?php echo ($vo["url"]); ?>"><img src="__PUBLIC__/Upload/video/<?php echo ($vo["img"]); ?>" /></a></td></tr>
                    		<tr><td align="center"><a href="<?php echo ($vo["url"]); ?>" style="display:block; height:20px; overflow:hidden"><?php echo ($vo["title"]); ?></a></td></tr>
                    	</table>
